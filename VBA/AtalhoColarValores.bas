...
' Essa macro foi desativada porque as novas versões do Excel 365 implementaram o mesmo comportamento de colar apenas valores
'no mesmo atalho utilizado aqui. Por isso não há motivo de manter o atalho com a desvantagem de matar o Ctrl+Z, isto é, perdendo o histórico de alterações.
